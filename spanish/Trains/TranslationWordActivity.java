...
public class TranslationWordActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tvWord.setText(translations.get(next));
        num = next;
        ...
        for (int i = num; i >= 0; i--) {
            if(isLearnt[i]) {
                ...
                reference.child("users").child(user.getUid()).child("dictionary")
                        .child(key.get(i)).child("isLearntTW").setValue(true);
            }
        }
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnCheckWT:
                ...
                if (etAnswer.getText().toString().equals(words.get(next))) {
                    ...
                    tvCorrect.setText(words.get(next));
